 ...
 *
 */
public class SgipSendBySplitLongThread extends Thread implements IControlService{
											...
											if(tmpForm.getMsg_content().length() > (70-qm)){
												...
												ArrayList<String> longMsg = new ArrayList<String>();
													...
													for(int i = 1;i<=longMsg.size();i++){
														...
														SGIPSubmitMessage submit = new SGIPSubmitMessage(tmpForm.getFull_sp_number(),mobile_tmp,longMsg.get(i-1),corp_id,server_id,node_id,longMsg.size(),i,msg_id);
													...
													SGIPSubmitMessage submit = new SGIPSubmitMessage(tmpForm.getFull_sp_number(), mobile_tmp, tmpForm.getMsg_content() , corp_id,server_id,node_id);
													socketChannel.write(submit.getMessage());
													SgipMessageUtil u = new SgipMessageUtil();
													u.setSgipMessage(submit);
