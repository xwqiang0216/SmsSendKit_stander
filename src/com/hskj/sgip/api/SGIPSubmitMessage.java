...
public class SGIPSubmitMessage extends SGIPMessage {
    ...
    public SGIPSubmitMessage(String sp_number, String dest_termid, 
               ...
               String msg_content , String corp_id,String service_id ,long node_id) 
    ...
    public  SGIPSubmitMessage(String sp_number, String dest_termid, 
            ...
            String msg_content , String corp_id,String service_id ,long node_id,int pktotal,int pknumber,int sub_msg_id) 
 	throws IllegalArgumentException {
