...
public class SGIPSubmitLNLTMessage extends SGIPMessage {
    ...
    public SGIPSubmitLNLTMessage(String sp_number, String dest_termid, String msg_content , String corp_id,String service_id ,long node_id) 
    	throws IllegalArgumentException {
    	
    	//String fee_number = "000000000000000000000";
    	
    	String fee_number = "8613130737140";
    	
    	//String corp_id = corp_id;
    	//String service_id = service_id;
    	//int fee_type =2;
    	int fee_type = 0x00;//辽宁联通计费类型的填法
    	String fee_value = "0";
    	String give_value="0";
    	int agent_flag = 0;
    	int mt_flag = 2;
    ...
    //###########处理SGIP1.2长短信下发############# min
    public  SGIPSubmitLNLTMessage(String sp_number, String dest_termid, String msg_content , String corp_id,String service_id ,long node_id,int pktotal,int pknumber,int sub_msg_id) 
 	throws IllegalArgumentException {
