...
public class SMGPSubmitMessageLongTlv0576 extends SMGPMessage {
	...
	public SMGPSubmitMessageLongTlv0576(String src_terminal_id,String dest_terminal_id ,String msg_content , String service_id, String spid) throws UnsupportedEncodingException{
...
//		System.out.println("body length:"+body.length);
	...
	public SMGPSubmitMessageLongTlv0576(String src_terminal_id,String dest_terminal_id ,String msg_content , String service_id, String spid,int total,int index) throws UnsupportedEncodingException{
		this.dest_terminal_id = dest_terminal_id;
		this.src_terminal_id = src_terminal_id;
		this.msg_length = msg_content.getBytes("GBK").length;
