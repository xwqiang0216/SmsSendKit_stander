...
public class SMGPSubmitMessageLongTlv extends SMGPMessage {
	...
	public SMGPSubmitMessageLongTlv(String src_terminal_id,String dest_terminal_id ,String msg_content , String service_id, String spid) throws UnsupportedEncodingException{
...
//		System.out.println("body length:"+body.length);
	...
	public SMGPSubmitMessageLongTlv(String src_terminal_id,String dest_terminal_id ,String msg_content , String service_id, String spid,int total,int index) throws UnsupportedEncodingException{
		this.dest_terminal_id = dest_terminal_id;
		this.src_terminal_id = src_terminal_id;
		this.msg_length = msg_content.getBytes("GBK").length;
		this.charge_terminal_id = src_terminal_id;
